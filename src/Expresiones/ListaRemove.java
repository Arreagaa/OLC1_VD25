...
/**
 * Método remove() - Elimina un elemento de la lista por posición y lo retorna
 * Sintaxis: var valor = miLista.remove(0);
 */
public class ListaRemove extends Instruccion {
    private String identificador;
    private Instruccion indice;

    public ListaRemove(String identificador, Instruccion indice, int linea, int columna) {
    ...
    public Object interpretar(Arbol arbol, tablaSimbolos tabla) {
        ...
        // Remover y obtener el elemento
        Object elementoRemovido = arrayList.remove(indiceInt);
        this.tipo = inferirTipo(elementoRemovido);
